...
public class JCasFSWriterAE extends linkJCasAnnotator {
	...
	public void process(JCas aJCas) throws AnalysisEngineProcessException {
		String filename =  ((SourceDocumentInformation) aJCas.getAnnotationIndex(SourceDocumentInformation.type).iterator().get()).getUri(); 
		// aJCas.getAnnotationIndex(SourceDocumentInformation.type).iterator().get().getFeatureValueAsString(aJCas.getTypeSystem().getFeatureByFullName("uri"));

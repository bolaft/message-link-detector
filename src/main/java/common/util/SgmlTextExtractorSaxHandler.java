...
public  class SgmlTextExtractorSaxHandler extends DefaultHandler {
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
		...
		if (containsNotContentTagSet(qName)) notContentTagDepth++;
	}
	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		...
		if (!characterFired) currentOpenElementWithTheBeginToSet--;
	...
	public void ignorableWhitespace(char[] ch, int start, int length) throws SAXException {
		if (notContentTagDepth==0) if (setPlainTextCursorsRelativelyToXmlTagCursors) detaggedText.append(ch, start, length);        
	}
